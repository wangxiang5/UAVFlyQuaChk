...
void CSysConfigureDataDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CHECK_AUTO_JUDGE, m_bCheckAutoJudge);
	DDX_Check(pDX, IDC_CHECK_AUTO_JUDGE, m_bAutoJudge);
}
...
// 	}
	...
	m_bAutoJudge = m_SysCfgData.bAutoJudgeUnion;
	UpdateData(FALSE);
}
void CSysConfigureDataDlg::UpdateDatas()
{
	...
	m_SysCfgData.bAutoJudgeUnion = m_bAutoJudge;
}
