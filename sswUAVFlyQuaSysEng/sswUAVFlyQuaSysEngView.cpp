...
// sswUAVFlyQuaSysEngView.cpp : CsswUAVFlyQuaSysEngView 类的实现
//
...
CsswUAVFlyQuaSysEngDoc* CsswUAVFlyQuaSysEngView::GetDocument() const // 非调试版本是内联的
{
...
// CsswUAVFlyQuaSysEngView 消息处理程序
...
void CsswUAVFlyQuaSysEngView::OnButtonSetImgValidState()
{
	...
	if(!m_bActSetInvalidImg)
	{
		...
		else
		{
			...
			switch(MessageBoxEx(NULL,"Please draw a polygon to choose images will be set to valid type.\nClick this button to complete setting.","提示",MB_OKCANCEL ,MAKELANGID(LANG_ENGLISH,SUBLANG_ENGLISH_US)))
			{
			case IDOK:
				break;
			default:
