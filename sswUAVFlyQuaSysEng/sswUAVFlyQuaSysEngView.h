...
// sswUAVFlyQuaSysEngView.h : CsswUAVFlyQuaSysEngView 类的接口
//

#pragma once
#include "sswViewerRender.h"
#include "MyFunctions.h"
class CsswUAVFlyQuaSysEngView : public CView
{
protected: // 仅从序列化创建
	CsswUAVFlyQuaSysEngView();
	DECLARE_DYNCREATE(CsswUAVFlyQuaSysEngView)

// 特性
public:
	CsswUAVFlyQuaSysEngDoc* GetDocument() const;
	double m_dLineTheta;
...
// 实现
public:
	virtual ~CsswUAVFlyQuaSysEngView();
#ifdef _DEBUG
...
#ifndef _DEBUG  // sswUAVFlyQuaSysEngView.cpp 中的调试版本
inline CsswUAVFlyQuaSysEngDoc* CsswUAVFlyQuaSysEngView::GetDocument() const
   { return reinterpret_cast<CsswUAVFlyQuaSysEngDoc*>(m_pDocument); }
#endif
