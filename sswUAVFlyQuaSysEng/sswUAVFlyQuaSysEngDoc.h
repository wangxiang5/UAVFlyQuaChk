...
// sswUAVFlyQuaSysEngDoc.h : CsswUAVFlyQuaSysEngDoc 类的接口
//
...
class CsswUAVFlyQuaSysEngDoc : public CDocument
{
protected: // 仅从序列化创建
	CsswUAVFlyQuaSysEngDoc();
	DECLARE_DYNCREATE(CsswUAVFlyQuaSysEngDoc)

protected:
	void ClearData();
	void UnionParaFormat();
public:
	bool PrjNew(CString strPath,vector<CsswUAVImage> &vecImgInfo, SSWstuSysConfigPara para, bool bWithCmr);
// 特性
public:
	/**2016-12-28**/
	bool m_bCmrFile;
...
// 操作
public:
	CsswUAVFlyQuaSysEngView* m_pView;
	CMainFrame* m_pMain;
// 重写
public:
...
// 实现
public:
	virtual ~CsswUAVFlyQuaSysEngDoc();
#ifdef _DEBUG
